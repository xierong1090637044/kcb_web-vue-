<template>
  <div style="position: relative;">
    ...
    <div style="padding:20px;background: #FFFFFF;margin-top: 20px;">
      <div style="padding:0 0 20px 0;font-size: 16px;font-weight: bold;">出入库统计：</div>
  ...
  export default {
    ...
    mounted() {
      ...
      mchart.getLineChart(year, month).then(res => {
        ...
        chart.line().position('date*_sumNum').color('desc');
        chart.render();
        ...
        chart.line().position('date*total_money').color('desc1');
        chart.render();
      })
    },
