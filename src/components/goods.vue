  ...
  <div>
    ...
    <div style="margin-bottom: 10px;display: flex;align-items: center;justify-content: space-between;">
      ...
      <div>
        ...
        <Button type="primary" @click="delete_good()" style="margin-right: 10px;">删除</Button>
    ...
    <Table :columns="columns" :data="goods" :loading="loading" ref="table" border size="small" :height="screenHeight - 240"
      ...
      <template slot-scope="{ row, index }" slot="action">
        <div style="display: flex;justify-content: center;">
          ...
          <div @click="deleteHeaderGood(row.objectId)"><Button type="primary" size="small">删除</Button></div>
