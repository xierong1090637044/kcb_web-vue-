		 ...
		 id="print_table">
			<template slot-scope="{ row, index }" slot="action">
				<div style="display: flex;justify-content: center;">
					...
					<div style="margin-right: 10px" @click="edit(row)"><Button type="primary" size="small">编辑</Button></div>
					<div @click="deleteHeaderGood(row.objectId)"><Button type="error" size="small">删除</Button></div>
