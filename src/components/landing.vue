    ...
    <div class="video-container">
      ...
      <div class="poster hidden" v-if="!vedioCanPlay">
		...
		<div class="index_content">
			<Row style="margin-top: 10%;" v-if="landing_type == 'landing'">
        <Col span="5" offset="9">
            <Card dis-hover>
							<div slot="title">
		...
		<Row style="margin-top: 10%;" v-if="landing_type == 'phone_landing'">
		    <Col span="5" offset="9">
		        <Card dis-hover>
							<div slot="title">
            ...
            password: [
                ...
                { type: 'string', min: 6, message: '密码不能少于6位', trigger: 'blur' }
						...
						phone: [
						    ...
						    { type: 'string', min: 11, message: '手机不能少于11位', trigger: 'blur' }
						]
        },
        vedioCanPlay: false,
        fixStyle: ''
