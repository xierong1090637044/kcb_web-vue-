<template>
  <div>
    ...
    <div style="background: #FFFFFF;padding: 1.25rem 1.25rem 0;">
      <div class="orderTitle">入库单</div>
      <div class="display_flex" style="margin-bottom: 1.875rem;">
        <div class="tableEle">
          <div class="tableRightEle">采购类型<span style="color: #f30;">*</span></div>
        ...
        <div class="tableEle">
          <div class="tableRightEle">入库仓库<span style="color: #f30;">*</span></div>
          <Input v-model="formItem.stock.stock_name" placeholder="请选择入库仓库" @on-focus="stockShow = true"></Input>
        </div>

        <div class="tableEle">
          <div class="tableRightEle">入库日期</div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        producerShow: false,
        goodsShow: false,
        allStockClass: ["采购入库", "销售退货入库", "调拨入库", "组装入库", "借用入库", "加工入库", "归还入库", "盘点入库", "退料入库", "委外入库", "委外退料入库",
          "返修入库", "其他入库"
        ],
        formItem: {
          stock: '',
