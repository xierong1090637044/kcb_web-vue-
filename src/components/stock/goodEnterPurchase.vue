  ...
  <div>
    ...
    <div style="background: #FFFFFF;padding: 1.25rem 1.25rem 0;">
      ...
      <div class="display_flex" style="margin-bottom: 1.875rem;">
        ...
        <div class="tableEle">
          <div class="tableRightEle">采购日期<span style="color: #f30;">*</span></div>
          <DatePicker type="datetime" placeholder="请选择采购日期" v-model="formItem.date" format="yyyy-MM-dd HH:mm:ss"></DatePicker>
        </div>

        <div class="tableEle">
          <div class="tableRightEle">供应商<span style="color: #f30;">*</span></div>
