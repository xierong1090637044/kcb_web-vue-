      ...
      <div class="control-form">
        <ul class="upload-imgs">
          <li v-if="imgLen>=1 ? false : true">
            <input type="file" class="upload" @change="addImg" ref="inputer" multiple accept="image/png,image/jpeg,image/gif,image/jpg" v-show="false"/>
            <a class="add" @click="upload"><i class="iconfont icon-plus"></i><p>点击上传</p></a>
          </li>
    ...
    export default {
        ...
        data () {
            return {
                ...
                ruleValidate: {
                    goodsName: [
                        { required: true, message: '产品名字必填', trigger: 'blur' }
                    ],
                }
            }
        },
...
.upload-imgs li{position: relative;width: 118px;height: 118px;font-size: 14px;display: inline-block;padding: 10px;margin-left: 60px;border: 2px dashed #ccc;text-align: center;vertical-align: middle;}
